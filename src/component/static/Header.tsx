  ...
  return (
    <div className={`w-full h-[65px] lg:h-[130px flex justify-center items-center shadow-m font-pop fixed z-40 bg-whit text-white  lg:shadow-m`}>
        ...
        {/* {
            ...
            <div className={` ${dropdown ? 'transform translate-y-0' : 'transform -translate-y-full'} lg:hidden w-[85%] h-[100vh] absolute bg-whit backdrop-blur-lg bg-[#000] bg-opacity-6 top-0 transition-all ease-in-out z-30 duration-300 left-0`} onClick={showDropdown}>
